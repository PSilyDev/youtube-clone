...
export const CategoriesBar = () => {
    ...
    return(
        ...
        //     </button>
        // </div>
        <div className="relative flex flex-nowrap justify-start items-center bg-red-400 cursor-pointer m-16 rounded-md h-12 px-3 max-w-screen-sm h-20">
            <div className="absolute h-full w-24">
